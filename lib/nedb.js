 ...
 * @param {String} connection URI as defined by the NeDB specification. Please 
 * check the documentation for details: https://github.com/louischatriot/nedb
 * @param {Object} [datastore] the data storage declared upon creation/loading.
 * All created documents within database has value { _lib: passwordless-token } 
 * as the default reference.
 * @constructor
 */
function NedbStore(datastore) {
    ...
    this.documentsName = 'passwordless-token'
